<template>
  ...
  >
    ...
    <span slot="footer">
      <!-- 提交按钮 -->
      <el-button type="primary" @click="updateModel">修改车型信息</el-button>
...
export default {
  ...
  methods: {
    openDialog(modelData) {
      this.dialogVisible = true;
      this.modelData = {
        model_id: Number(modelData.model_id),
        model_brand: modelData.brand_name,
        model_name: modelData.model_name,
        imageUrls: modelData.image_paths,
        range: modelData.max_range,
        power_type: modelData.power_type,
        sale_price: modelData.purchase_price,
        rental_price: modelData.leasing_price,
        charging_power: modelData.peak_power,
        acceleration: modelData.acceleration,
        seats: modelData.seat_count,
        storage_space: modelData.storage_space,
      };
    },
